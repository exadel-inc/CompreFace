...
export const selectCurrentOrganizationId = createSelector(selectOrganizationState, (state) => state.selectId);
...
export const selectUserRollForSelectedOrganization = createSelector(selectSelectedOrganization, (organization) =>
