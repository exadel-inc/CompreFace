...
@NgModule({
  ...
  providers: [ApplicationListFacade],
    imports: [CommonModule, TableModule, SpinnerModule, MatButtonModule, SnackBarModule, MatCardModule, MatIconModule, TranslateModule, FormsModule, TablePipeModule, MatInputModule],
})
