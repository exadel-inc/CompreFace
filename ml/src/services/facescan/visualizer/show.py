...
def _draw_detection_box(img_draw, box, font_size, font, box_line_width, color, text):
...
def show_img(img: Array3D, boxes: List[BoundingBox] = None, noses: List[Tuple[int, int]] = None):
    ...
    for i, box in enumerate(boxes):
        ...
        text = str(i + 1)
        _draw_detection_box(img_draw, box, font_size, font, box_line_width, color, text)
