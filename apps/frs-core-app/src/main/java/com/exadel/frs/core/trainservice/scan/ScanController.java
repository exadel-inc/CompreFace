...
import com.exadel.frs.core.trainservice.retrain.RetrainService;
import com.exadel.frs.core.trainservice.retrain.RetrainStatus;
...
public class ScanController {
    ...
    public void scanFaces(
        ...
        retrainStatus.run(systemService.getApiKeyAndModelApiKey(xApiKey), retrainService);
        //and after save
