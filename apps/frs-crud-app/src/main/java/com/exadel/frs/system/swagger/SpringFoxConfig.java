...
public class SpringFoxConfig {
    ...
    public SecurityConfiguration securityInfo(OAuthClientProperties oAuthClientProperties) {
        var clientId = oAuthClientProperties.getClients().get(OAuthClientProperties.ClientType.COMMON).getClientId();
        var clientSecret = oAuthClientProperties.getClients().get(OAuthClientProperties.ClientType.COMMON)
                .getClientSecret();
